package com.bruce.dingding.utils;
...
public class FileUtils {
    ...
    private static final String FILEPATH = "DING_TOKEN";
     ...
     */
    public synchronized static void write2File(DingToken accessToken, TokenTypeEnum tokenType) {
        ...
        List<DingToken> zwddTokenList = read(tokenType);
     ...
     * @return token
     */
    public static List<DingToken> read(TokenTypeEnum tokenType) {
        String fileName = getFileName(tokenType);
        if (StringUtils.isBlank(fileName)) {
            return null;
        }
        ...
        return JSONObject.parseArray(sb.toString(), DingToken.class);
    }
     ...
     * @return 相应的 value
     */
    public static DingToken getValue(TokenTypeEnum tokenType, String appKey) {
        List<DingToken> list = read(tokenType);
